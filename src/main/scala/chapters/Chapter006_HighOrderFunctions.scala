...
class Chapter006_HighOrderFunctions extends ChapterBase {

	printTitle("High-order functions", "https://docs.scala-lang.org/tour/higher-order-functions.html")
	...
	//====================================================================================
	printSubtitle("Coercing methods into functions", true)
	...
	//====================================================================================
	printSubtitle("Functions that accept functions", true)
	...
	//====================================================================================
	printSubtitle("Functions that return functions", true)
