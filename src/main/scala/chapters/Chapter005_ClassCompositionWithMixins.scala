...
class Chapter005_ClassCompositionWithMixins extends ChapterBase {

	printTitle("Class Composition with Mixins", "https://docs.scala-lang.org/tour/mixin-class-composition.html")
