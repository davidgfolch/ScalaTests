...
class Chapter003_Classes extends ChapterBase {
	...
	//====================================================================================
	printSubtitle("Private Members and Getter/Setter Syntax", true)
