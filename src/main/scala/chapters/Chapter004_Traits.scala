...
class Chapter004_Traits extends ChapterBase {

	printTitle("Traits", "https://docs.scala-lang.org/tour/traits.html")

	//====================================================================================
	printSubtitle("Defining a trait", false)
